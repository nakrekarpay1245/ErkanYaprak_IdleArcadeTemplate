...
public class TopDownCharacterController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //_speedHashCode = Animator.StringToHash("Speed");
    }
    ...
    private void HandleMovement()
    {
        ...
        //// Set speed in Animator based on the magnitude of the current velocity
        //_animator.SetFloat(_speedHashCode, _currentVelocity.magnitude / _movementSpeed);
